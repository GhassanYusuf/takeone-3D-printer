...
#define STRING_CONFIG_H_AUTHOR "Ghassan Yusuf" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TAKEONE 3D"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 88.89, 88.89, 400, 101 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 18000, 18000, 3000, 200 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION   (Y_BED_SIZE - 18)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    40 //4         // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
  #define NEOPIXEL_PIXELS 22        // Number of LEDs in the strip
